...
def generateCode():
    ...
    messagebox.showinfo("QR Code Generator", "QR Code is generated")

# Label for the window
headingFrame = Frame(wn, bg="azure", bd=5)
headingFrame.place(relx=0.15, rely=0.05, relwidth=0.7, relheight=0.1)
headingLabel = Label(headingFrame, text="Generate Your QR Code", bg='azure', font=('Times', 20, 'bold'))
headingLabel.place(relx=0, rely=0, relwidth=1, relheight=1)

# Taking the input of the text or URL to get QR code
Frame1 = Frame(wn, bg="green")  # Changed background color to green
Frame1.place(relx=0.1, rely=0.15, relwidth=0.7, relheight=0.3)

lable1 = Label(Frame1, text="Enter the URL: ", bg="green", fg='azure', font=('Courier', 13, 'bold'))
...
Frame2 = Frame(wn, bg="green")  # Changed background color to green
Frame2.place(relx=0.1, rely=0.35, relwidth=0.7, relheight=0.3)

lable2 = Label(Frame2, text="Enter the location to save the QR Code: ", bg="green", fg='azure', font=('Courier', 13, 'bold'))
...
Frame3 = Frame(wn, bg="green")  # Changed background color to green
Frame3.place(relx=0.1, rely=0.55, relwidth=0.7, relheight=0.3)

lable3 = Label(Frame3, text="Enter the name of the QR Code: ", bg="green", fg='azure', font=('Courier', 13, 'bold'))
...
Frame4 = Frame(wn, bg="green")  # Changed background color to green
Frame4.place(relx=0.1, rely=0.75, relwidth=0.7, relheight=0.2)

lable4 = Label(Frame4, text="Enter the size from 1 to 40 with 1 being 21x21: ", bg="green", fg='azure', font=('Courier', 13, 'bold'))
